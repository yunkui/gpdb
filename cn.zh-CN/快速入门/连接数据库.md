...
您可以从 [PostgreSQL 官网](https://www.postgresql.org/ftp/pgadmin3/release/v1.6.3/) 下载 pgAdmin III 1.6.3。pgAdmin III 1.6.3 支持各种平台，例如 Windows、MacOS 和 Linux。其它图形客户端，详情参见 [图形客户端工具](https://help.aliyun.com/document_detail/35428.html?spm=a2c4g.11186623.6.553.E6s71O#guitool)。
